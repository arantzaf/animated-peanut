...
#set_property PACKAGE_PIN U9 [get_ports {rsw[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {rsw[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
#set_property PACKAGE_PIN U8 [get_ports {rsw[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {rsw[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports {rsw[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {rsw[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
#set_property PACKAGE_PIN R6 [get_ports {rsw[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {rsw[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
#set_property PACKAGE_PIN R5 [get_ports {gsw[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {gsw[0]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
#set_property PACKAGE_PIN V7 [get_ports {gsw[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {gsw[1]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
#set_property PACKAGE_PIN V6 [get_ports {gsw[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {gsw[2]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
#set_property PACKAGE_PIN V5 [get_ports {gsw[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {gsw[3]}]
##Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
#set_property PACKAGE_PIN U4 [get_ports {bsw[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {bsw[0]}]
##Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
#set_property PACKAGE_PIN V2 [get_ports {bsw[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {bsw[1]}]
##Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = SW10
#set_property PACKAGE_PIN U2 [get_ports {bsw[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {bsw[2]}]
##Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = SW11
#set_property PACKAGE_PIN T3 [get_ports {bsw[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {bsw[3]}]
...
#Bank = 34, Pin name = IO_L24N_T3_34,						Sch name = LED0
    set_property PACKAGE_PIN T8 [get_ports {scan_out[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {scan_out[0]}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
    set_property PACKAGE_PIN V9 [get_ports {scan_out[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {scan_out[1]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
    set_property PACKAGE_PIN R8 [get_ports {scan_out[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {scan_out[2]}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
    set_property PACKAGE_PIN T6 [get_ports {scan_out[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {scan_out[3]}]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
    set_property PACKAGE_PIN T5 [get_ports {scan_out[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {scan_out[4]}]
#Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
    set_property PACKAGE_PIN T4 [get_ports {scan_out[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {scan_out[5]}]
#Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
    set_property PACKAGE_PIN U7 [get_ports {scan_out[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {scan_out[6]}]
#Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
    set_property PACKAGE_PIN U6 [get_ports {scan_out[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {scan_out[7]}]
##Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LED8
#set_property PACKAGE_PIN V4 [get_ports {scan_code[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {scan_code[8]}]
##Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
#set_property PACKAGE_PIN U3 [get_ports {scan_code[9]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {scan_code[9]}]
##Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
#set_property PACKAGE_PIN V1 [get_ports {scan_code[10]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {scan_code[10]}]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
#set_property PACKAGE_PIN R1 [get_ports {scan_code[11]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {scan_code[11]}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
#set_property PACKAGE_PIN P5 [get_ports {scan_code[12]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {scan_code[12]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
#set_property PACKAGE_PIN U1 [get_ports {scan_code[13]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {scan_code[13]}]
###Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {miss}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {miss}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
    set_property PACKAGE_PIN P2 [get_ports {led}]					
...
#Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
    set_property PACKAGE_PIN R10 [get_ports reset_clk]						
