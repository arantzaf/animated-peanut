...
##Bank = 34, Pin name = IO_L17N_T2_34,						Sch name = SW12
   # set_property PACKAGE_PIN T1 [get_ports {dp0}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {dp0}]
##Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = SW13
   # set_property PACKAGE_PIN R3 [get_ports {dp1}]					
    #set_property IOSTANDARD LVCMOS33 [get_ports {dp1}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
   #  set_property PACKAGE_PIN P3 [get_ports {reset_clk}]					
...
#set_property PACKAGE_PIN T8 [get_ports {scan_data[7]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {scan_data[7]}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports {dout[6]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {dout[6]}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2#
#set_property PACKAGE_PIN R8 [get_ports {dout[5]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {dout[5]}]
##Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN T6 [get_ports {scan_data[4]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {dout[4]}]
##Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
#set_property PACKAGE_PIN T5 [get_ports {dout[3]} ]					
#set_property IOSTANDARD LVCMOS33 [get_ports {dout[3]}]
##Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN T4 [get_ports {dout[2]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {dout[2]}]
##Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
#set_property PACKAGE_PIN U7 [get_ports {dout[1]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {dout[1]}]
##Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
#set_property PACKAGE_PIN U6 [get_ports {dout[0]}]					
...
#set_property PACKAGE_PIN P2 [get_ports {rx_done_tick}]					
...
#set_property PACKAGE_PIN T16 [get_ports {btn[0]}]						
#set_property IOSTANDARD LVCMOS33 [get_ports {btn[0]}]
...
##Bank = 15, Pin name = IO_L6P_T0_15,						Sch name = AUD_SD
    set_property PACKAGE_PIN D12 [get_ports audSD]						
